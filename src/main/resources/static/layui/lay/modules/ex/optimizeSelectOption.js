...
;!function (factory) {
    ...
    // 过渡一下，如果采用mylayui，已经直接在form.js里面处理而且更加的高效合理，如果不准备使用mylayui的话还是按照之前的处理方式
    if (!layui.mylayui && !form.render.plugFlag) {
        // 只要未改造过的才需要改造一下
        // 保留一下原始的form.render
    ...
    render('layuiSelect', {
        ...
        success: function (index, layero) {
            ...
            layui.mylayui ? form.render(selectElem) : form.render('select', null, selectElem);
        }
    });
