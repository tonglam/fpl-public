...
// Configure plugin namespace
	...
	}, {"./annotation.js": 2, "./element.js": 3, "./types/box.js": 7, "./types/line.js": 8, "chart.js": 1}],
		...
		module.exports = function (Chart) {
			...
			var BoxAnnotation = Chart.Annotation.Element.extend({
				...
				configure: function () {
					...
					var boxHeight = model.top - model.bottom;
					var boxWidth = model.right - model.left;
					var labelPosition = calculateLabelPosition(model, textWidth, textHeight + boxHeight, model.labelXPadding, model.labelYPadding, boxWidth);
					// model.labelX = model.left + model.labelXPadding;
					model.labelX = labelPosition.x - model.labelXPadding;
					model.labelY = labelPosition.y - model.labelYPadding;
					// model.labelWidth = 2 * model.labelXPadding;
				...
				draw: function () {
					...
					if (model.labelPosition === 'left') textAlign = 'right';
					if (model.labelPosition === 'right') textAlign = 'left';
					var view = this._view;
					var view = this._view;
					...
					if (view.Shape === "Diamond") {
						ctx.moveTo(view.left, view.top + height / 2);
						ctx.lineTo(view.left + width / 2, view.bottom);
						ctx.lineTo(view.right, view.bottom - height / 2);
						ctx.lineTo(view.right - width / 2, view.top);
						ctx.lineTo(view.left, view.top + height / 2);
					}

					if (view.Shape === "Triangle") {
						ctx.moveTo(view.left, view.bottom);
						ctx.lineTo(view.left + width / 2, view.top);
						ctx.lineTo(view.right, view.bottom);
						ctx.lineTo(view.left, view.bottom);
					}

					if (view.Shape === "Upside-down triangle") {
						ctx.moveTo(view.left, view.top);
						ctx.lineTo(view.left + width / 2, view.bottom);
						ctx.lineTo(view.right, view.top);
						ctx.lineTo(view.left, view.top);
					}

					if (view.Shape === "Star") {
						var rot = Math.PI / 2 * 3;
						var cx = view.left + width / 2;
						var cy = view.top + height / 2;
						var spikes = 5;
						var outerRadius = width / 2;
						var innerRadius = width / spikes;
						var x = cx;
						var y = cy;
					...
					if (view.Shape === "Circle")
						ctx.arc(view.left + width / 2, view.top + height / 2, (width / 2), 0, Math.PI * 2, true);
			...
			function calculateLabelPosition(view, width, height, padWidth, padHeight, boxWidth) {
				var line = view.line;
				var ret = {}, xa = 0, ya = 0;
				...
				switch (true) {
					...
					case view.mode == horizontalKeyword && view.labelPosition === "right":
						xa = view.labelXAdjust - (width / 2) + padWidth;
						ya = view.labelYAdjust - (height / 2);
						ret.x = view.right + xa;
						ret.y = view.y1 + ya;
						break;
					...
					// center align
					default:
						xa = view.labelXAdjust + (boxWidth / 2) - (width / 2) + (padWidth / 2);
						ya = view.labelYAdjust - (height / 2);
						ret.x = view.left + xa;
						ret.y = view.y1 + ya;
				}
