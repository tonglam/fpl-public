...
public class StatController {
    ...
    @ResponseBody
    public TableData<PlayerData> qryPageScoutPlayerList(@RequestParam int elementType, int page, int limit) {
        return this.statApi.qryPageScoutPlayerList(elementType, page, limit);
    }
