...
public class TournamentController {
	...
	public String createController(Model model, HttpSession session) {
		model.addAttribute("gwMap", CommonUtils.createGwMapStartFromCurrentForOption(this.tournamentApi.getNextEvent()));
		int zjGroupNum = 4;
	...
	public String zjReloadController(@RequestParam int zjGroupNum, @RequestParam int zjTeamPerGroup, HttpSession session) {
