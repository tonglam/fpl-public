...
public class UpdateEventResultServiceImpl implements IUpdateEventResultService {
    ...
    public void updateTournamentResult(int event, int tournamentId) {
        ...
        this.entryEventResultService.saveOrUpdateBatch(updateEventResultList);
    }
...
//        this.tournamentPointsGroupResultService.saveBatch(insertGroupPointsResultList);
    ...
    private Table<Integer, Integer, Integer> updateGroupBattleResult(int event, int tournamentId, Map<Integer, EntryEventResultEntity> eventResultMap) {
        ...
        // update
        this.tournamentBattleGroupResultService.saveBatch(updateGroupBattleResultList);
        // return
...
//        this.tournamentGroupService.updateBatchById(updateGroupList);
    ...
    private void updateNextKnockout(int tournamentId, @NotEmpty Map<Integer, TournamentKnockoutNextRoundData> nextKouckoutMap) {
        ...
        this.tournamentKnockoutResultService.saveBatch(updateKnockoutResultList);
    }
