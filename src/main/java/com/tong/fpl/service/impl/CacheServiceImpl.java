...
//			this.SetPersistCache(cacheMap);
    ...
    @Override
    public <T> String createKey(T entity, String keyName, Object key) {
        return createKey(CommonUtils.getCurrentSeason(), entity, keyName, key);
    }

    @Override
    public <T> String createKey(String season, T entity, String keyName, Object key) {
        return StringUtils.joinWith("::", entity.getClass().getSimpleName(), keyName, season, key);
    }

    @Override
    public void setCache(Map<String, Object> cacheMap, long expireSeconds) {
    ...
    @Override
    public List<Object> getMultiValues(String pattern) {
