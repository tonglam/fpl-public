...
public class LiveService implements ILiveService {
    ...
    private LiveCalaData calcLiveSingleEntryPoints(int event, int entry, UserPicksRes userPicksRes, Map<Integer, PlayerEntity> playerInfoMap) {
        ...
        List<ElementLiveData> elementLiveDataList = this.initElemetLiveData(event, userPicksRes.getPicks(), playerInfoMap);
        // get active picks
    ...
    private List<ElementLiveData> initElemetLiveData(int event, List<Pick> picks, Map<Integer, PlayerEntity> playerInfoMap) {
