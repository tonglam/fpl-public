...
public class LiveService implements ILiveService {
	...
	public LiveCalaData calcLivePointsByEntry(int event, int entry) {
		...
		if (entryInfoEntity != null) {
			...
			liveCalaData
					.setLiveTotalPoints(liveCalaData.getLastOverallPoints() + liveCalaData.getLiveNetPoints());
		}
		return liveCalaData;
	}
	...
	private void setEventLiveBonusData(ElementEventResultData elementEventResultData, EventLiveEntity eventLiveEntity, Table<Integer, Integer, Integer> liveBonusTable) {
		...
		if (elementEventResultData.isPlayed()) {
			elementEventResultData.setBonus(eventLiveEntity.getBonus());
			elementEventResultData.setTotalPoints(elementEventResultData.getTotalPoints());
		} else {
