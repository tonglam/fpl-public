...
public class QueryServiceImpl implements IQuerySerivce {
	...
	@Cacheable(value = "allPlayer")
	@Override
	public Map<Integer, PlayerEntity> getAllPlayerList(String season) {
	...
	@Cacheable(value = "allPlayerStat")
	@Override
	public Map<Integer, PlayerStatEntity> getAllPlayerStatList(String season) {
		MybatisPlusConfig.season.set(season);
	...
	@Cacheable(value = "entryEventResult")
	@Override
	...
	public PlayerData qryPlayerData(PlayerQueryParam playerQueryParam) throws Exception {
		...
		return this.qryPlayerData(playerEntity.getElement());
	}
	...
	private PlayerInfoData initPlayerInfo(PlayerEntity playerEntity) {
		...
		return new PlayerInfoData()
				...
				.setElementTypeName(positonMap.get(playerEntity.getElementType()))
